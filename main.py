...
class Character:
    ...
    def __init__(self, name):
        """Конструктор принимает класс персонажа."""
        self.name = name

    def attack(self):
        """Возвращает строку сообщения о нанесённом персонажем."""
    ...
    def special(self):
        """Возвращает строку сообщения об специальном умении персонажа."""
        return (f'{self.name} применил специальное умение '
                f'"{self.SPECIAL_SKILL} {self.SPECIAL_BUFF}".')

    def __str__(self):
        """Переопределяем стандартный метод __str__."""
        return f'{self.__class__.__name__} - {self.BRIEF_DESC_CHAR_CLASS}.'


class Warrior(Character):
    """Describes class warrior."""
